...
# Local-first development default. Set DJANGO_SECRET_KEY if you run this outside
# an isolated local lab.
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'ctf-report-forge-local-development-key')
